...
def build_global_rife_settings(
    ...
    settings: Dict[str, Any] = {
        ...
        "h265_tune": output_settings.get("h265_tune", "none"),
        "av1_film_grain": output_settings.get("av1_film_grain", 8),
        "av1_film_grain_denoise": bool(output_settings.get("av1_film_grain_denoise", False)),
