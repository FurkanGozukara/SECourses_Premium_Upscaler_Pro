...
def seedvr2_tab(
    ...
    with gr.Row():
        ...
        with gr.Column(scale=3):
            ...
            with gr.Row():
                ...
                latent_noise_scale = gr.Slider(
                    ...
                    info="Add noise in latent space during diffusion. Can improve detail generation. 0.0 = no noise. Typical: 0.0-0.05. Default: 0.0.",
                    scale=2,
                )
        ...
        with gr.Column(scale=2):
            ...
            with gr.Group(
                visible=False,
                elem_id="seed-autotune-notice-modal",
                elem_classes=["autotune-modal-overlay"],
            ) as seed_autotune_notice_modal:
    ...
    auto_tune_btn.click(
        ...
        concurrency_id="app_processing_queue",
        trigger_mode="multiple",
        js=autotune_modal_reset_js("seed-autotune-notice-modal"),
    )
    ...
    seed_autotune_notice_ok_btn.click(
        ...
        queue=False,
        show_progress="hidden",
        js=autotune_modal_dismiss_js("seed-autotune-notice-modal"),
    )
    ...
    def handle_cancel_with_confirmation(confirm_checked, state):
        ...
        if not confirm_checked:
            ...
            return (
                gr.update(value=f"WARNING: {message}", visible=True),
